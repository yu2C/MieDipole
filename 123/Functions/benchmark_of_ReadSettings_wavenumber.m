...
title('$$\mathrm{wavenumber}~\mathrm{k}_{0}$$','Interpreter', 'latex', 'FontName', 'Times New Roman', 'FontSize', 22);
...
xlabel('$$\mathrm{values}~(\mathrm{cm}^{-1})$$','interpreter','latex', 'FontSize', 18);
