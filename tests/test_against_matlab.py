"""Compare Python port output against MATLAB golden .mat files in benchmark/."""
...
@pytest.fixture(scope="module")
def main_result_py():
    """Run main.py once and load its output."""
    subprocess.run(
    ...
    return load_mat(FUNCTION_DIR / "main_result.mat")


def test_main_cf_self_consistent(main_result_py):
    """Regression: two consecutive runs produce identical CF."""
    ...
    second = load_mat(FUNCTION_DIR / "main_result.mat")
