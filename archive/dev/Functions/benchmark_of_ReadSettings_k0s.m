...
subtracted_struct.NP = ans.Settings.k0s - Settings_py.k0s';
...
title('$$\mathrm{k}_0\mathrm{r}$$','Interpreter', 'latex', 'FontSize', 22);

xticks([0, 100, 200, 300, 400]);  % Adjust these values accordingly
xticklabels({'1.4661', '1.1023', '0.8814', '0.7343', '0.6292'});  % Labels for the ticks
