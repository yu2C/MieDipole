...
ax.plot_surface(z_real, z_imag, np.abs(csj_values), cmap='viridis')
...
ax.set_zlim(0, 0.6)  # Limit z-axis for better visualization
...
plt.colorbar(ax.plot_surface(z_real, z_imag, np.abs(csj_values), cmap='viridis'), ax=ax, shrink=0.5, aspect=10)
